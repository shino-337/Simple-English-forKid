...
const proxyAgent = new SocksProxyAgent('socks5://localhost:8081');
...
const pixabayClient = axios.create({
  ...
  httpsAgent: proxyAgent, // Use SOCKS5 proxy for HTTPS
  httpAgent: proxyAgent // Use SOCKS5 proxy for HTTP
});
